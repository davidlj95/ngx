## API Report File for "@davidlj95/ngx"
...
// @public (undocumented)
export const makeKeyValMetaDefinition: (opts: { keyAttr?: string; keyName: string; valAttr?: string }) => NgxMetaMetaDefinition
...
export class NgxMetaCoreModule {
  // (undocumented)
  static forRoot(options?: { defaults?: MetadataValues }): ModuleWithProviders<NgxMetaCoreModule>
}
